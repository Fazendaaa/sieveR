...
RcppExport SEXP _sieveR_erastosthenesSieve(SEXP limitSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_sieveR_erastosthenesSieve", (DL_FUNC) &_sieveR_erastosthenesSieve, 1},
    {NULL, NULL, 0}
};

RcppExport void R_init_sieveR(DllInfo *dll) {
